...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrefixTemplate) DeepCopyInto(out *PrefixTemplate) {
	*out = *in
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrefixTemplate.
func (in *PrefixTemplate) DeepCopy() *PrefixTemplate {
	if in == nil {
		return nil
	}
	out := new(PrefixTemplate)
