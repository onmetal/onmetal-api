...
type VolumeSpecApplyConfiguration struct {
	...
	ClaimRef           *v1beta1.LocalUIDReferenceApplyConfiguration `json:"claimRef,omitempty"`
	...
	Tolerations        []v1beta1.TolerationApplyConfiguration       `json:"tolerations,omitempty"`
...
func (b *VolumeSpecApplyConfiguration) WithClaimRef(value *v1beta1.LocalUIDReferenceApplyConfiguration) *VolumeSpecApplyConfiguration {
	b.ClaimRef = value
	return b
}
...
func (b *VolumeSpecApplyConfiguration) WithResources(value corev1beta1.ResourceList) *VolumeSpecApplyConfiguration {
	b.Resources = &value
	return b
}
...
func (b *VolumeSpecApplyConfiguration) WithTolerations(values ...*v1beta1.TolerationApplyConfiguration) *VolumeSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
