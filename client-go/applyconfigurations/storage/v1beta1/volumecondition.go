...
type VolumeConditionApplyConfiguration struct {
	Type               *v1beta1.VolumeConditionType `json:"type,omitempty"`
...
func (b *VolumeConditionApplyConfiguration) WithType(value v1beta1.VolumeConditionType) *VolumeConditionApplyConfiguration {
	b.Type = &value
	return b
}
