...
type BucketConditionApplyConfiguration struct {
	Type               *v1beta1.BucketConditionType `json:"type,omitempty"`
...
func (b *BucketConditionApplyConfiguration) WithType(value v1beta1.BucketConditionType) *BucketConditionApplyConfiguration {
	b.Type = &value
	return b
}
