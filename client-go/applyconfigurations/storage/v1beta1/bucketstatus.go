...
type BucketStatusApplyConfiguration struct {
	State                   *v1beta1.BucketState                `json:"state,omitempty"`
...
func (b *BucketStatusApplyConfiguration) WithState(value v1beta1.BucketState) *BucketStatusApplyConfiguration {
	b.State = &value
	return b
}
