...
type VolumePoolStatusApplyConfiguration struct {
	State                  *v1beta1.VolumePoolState                `json:"state,omitempty"`
...
func (b *VolumePoolStatusApplyConfiguration) WithState(value v1beta1.VolumePoolState) *VolumePoolStatusApplyConfiguration {
	b.State = &value
	return b
}
...
func (b *VolumePoolStatusApplyConfiguration) WithCapacity(value corev1beta1.ResourceList) *VolumePoolStatusApplyConfiguration {
	b.Capacity = &value
	return b
}
...
func (b *VolumePoolStatusApplyConfiguration) WithAllocatable(value corev1beta1.ResourceList) *VolumePoolStatusApplyConfiguration {
	b.Allocatable = &value
	return b
}
