...
// Experimental!
func ExtractVolume(volume *storagev1beta1.Volume, fieldManager string) (*VolumeApplyConfiguration, error) {
...
// Experimental!
func ExtractVolumeStatus(volume *storagev1beta1.Volume, fieldManager string) (*VolumeApplyConfiguration, error) {
	return extractVolume(volume, fieldManager, "status")
}

func extractVolume(volume *storagev1beta1.Volume, fieldManager string, subresource string) (*VolumeApplyConfiguration, error) {
	b := &VolumeApplyConfiguration{}
	err := managedfields.ExtractInto(volume, internal.Parser().Type("com.github.onmetal.onmetal-api.api.storage.v1beta1.Volume"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
