...
// Experimental!
func ExtractBucketClass(bucketClass *storagev1beta1.BucketClass, fieldManager string) (*BucketClassApplyConfiguration, error) {
...
// Experimental!
func ExtractBucketClassStatus(bucketClass *storagev1beta1.BucketClass, fieldManager string) (*BucketClassApplyConfiguration, error) {
	return extractBucketClass(bucketClass, fieldManager, "status")
}

func extractBucketClass(bucketClass *storagev1beta1.BucketClass, fieldManager string, subresource string) (*BucketClassApplyConfiguration, error) {
	b := &BucketClassApplyConfiguration{}
	err := managedfields.ExtractInto(bucketClass, internal.Parser().Type("com.github.onmetal.onmetal-api.api.storage.v1beta1.BucketClass"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
func (b *BucketClassApplyConfiguration) WithCapabilities(value v1beta1.ResourceList) *BucketClassApplyConfiguration {
