...
type BucketPoolStatusApplyConfiguration struct {
	State                  *v1beta1.BucketPoolState  `json:"state,omitempty"`
...
func (b *BucketPoolStatusApplyConfiguration) WithState(value v1beta1.BucketPoolState) *BucketPoolStatusApplyConfiguration {
	b.State = &value
	return b
}
