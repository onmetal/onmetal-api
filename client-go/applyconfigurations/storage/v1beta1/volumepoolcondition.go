...
type VolumePoolConditionApplyConfiguration struct {
	Type               *v1beta1.VolumePoolConditionType `json:"type,omitempty"`
...
func (b *VolumePoolConditionApplyConfiguration) WithType(value v1beta1.VolumePoolConditionType) *VolumePoolConditionApplyConfiguration {
	b.Type = &value
	return b
}
