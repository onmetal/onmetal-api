...
// Experimental!
func ExtractBucket(bucket *storagev1beta1.Bucket, fieldManager string) (*BucketApplyConfiguration, error) {
...
// Experimental!
func ExtractBucketStatus(bucket *storagev1beta1.Bucket, fieldManager string) (*BucketApplyConfiguration, error) {
	return extractBucket(bucket, fieldManager, "status")
}

func extractBucket(bucket *storagev1beta1.Bucket, fieldManager string, subresource string) (*BucketApplyConfiguration, error) {
	b := &BucketApplyConfiguration{}
	err := managedfields.ExtractInto(bucket, internal.Parser().Type("com.github.onmetal.onmetal-api.api.storage.v1beta1.Bucket"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
