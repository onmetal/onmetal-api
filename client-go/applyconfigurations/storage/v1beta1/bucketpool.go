...
// Experimental!
func ExtractBucketPool(bucketPool *storagev1beta1.BucketPool, fieldManager string) (*BucketPoolApplyConfiguration, error) {
...
// Experimental!
func ExtractBucketPoolStatus(bucketPool *storagev1beta1.BucketPool, fieldManager string) (*BucketPoolApplyConfiguration, error) {
	return extractBucketPool(bucketPool, fieldManager, "status")
}

func extractBucketPool(bucketPool *storagev1beta1.BucketPool, fieldManager string, subresource string) (*BucketPoolApplyConfiguration, error) {
	b := &BucketPoolApplyConfiguration{}
	err := managedfields.ExtractInto(bucketPool, internal.Parser().Type("com.github.onmetal.onmetal-api.api.storage.v1beta1.BucketPool"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
