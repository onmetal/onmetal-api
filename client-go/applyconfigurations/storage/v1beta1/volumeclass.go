...
type VolumeClassApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Capabilities                     *v1beta1.ResourceList        `json:"capabilities,omitempty"`
	ResizePolicy                     *storagev1beta1.ResizePolicy `json:"resizePolicy,omitempty"`
}
...
func VolumeClass(name string) *VolumeClassApplyConfiguration {
	...
	b.WithAPIVersion("storage.api.onmetal.de/v1beta1")
	return b
}
...
// Experimental!
func ExtractVolumeClass(volumeClass *storagev1beta1.VolumeClass, fieldManager string) (*VolumeClassApplyConfiguration, error) {
...
// Experimental!
func ExtractVolumeClassStatus(volumeClass *storagev1beta1.VolumeClass, fieldManager string) (*VolumeClassApplyConfiguration, error) {
	return extractVolumeClass(volumeClass, fieldManager, "status")
}

func extractVolumeClass(volumeClass *storagev1beta1.VolumeClass, fieldManager string, subresource string) (*VolumeClassApplyConfiguration, error) {
	b := &VolumeClassApplyConfiguration{}
	err := managedfields.ExtractInto(volumeClass, internal.Parser().Type("com.github.onmetal.onmetal-api.api.storage.v1beta1.VolumeClass"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
func (b *VolumeClassApplyConfiguration) WithCapabilities(value v1beta1.ResourceList) *VolumeClassApplyConfiguration {
...
func (b *VolumeClassApplyConfiguration) WithResizePolicy(value storagev1beta1.ResizePolicy) *VolumeClassApplyConfiguration {
