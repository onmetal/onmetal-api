...
// Experimental!
func ExtractVolumePool(volumePool *storagev1beta1.VolumePool, fieldManager string) (*VolumePoolApplyConfiguration, error) {
...
// Experimental!
func ExtractVolumePoolStatus(volumePool *storagev1beta1.VolumePool, fieldManager string) (*VolumePoolApplyConfiguration, error) {
	return extractVolumePool(volumePool, fieldManager, "status")
}

func extractVolumePool(volumePool *storagev1beta1.VolumePool, fieldManager string, subresource string) (*VolumePoolApplyConfiguration, error) {
	b := &VolumePoolApplyConfiguration{}
	err := managedfields.ExtractInto(volumePool, internal.Parser().Type("com.github.onmetal.onmetal-api.api.storage.v1beta1.VolumePool"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
func (b *VolumePoolApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
