...
type NetworkInterfaceStatusApplyConfiguration struct {
	State                   *v1beta1.NetworkInterfaceState `json:"state,omitempty"`
...
func (b *NetworkInterfaceStatusApplyConfiguration) WithState(value v1beta1.NetworkInterfaceState) *NetworkInterfaceStatusApplyConfiguration {
	b.State = &value
	return b
}
...
func (b *NetworkInterfaceStatusApplyConfiguration) WithIPs(values ...commonv1beta1.IP) *NetworkInterfaceStatusApplyConfiguration {
	for i := range values {
...
func (b *NetworkInterfaceStatusApplyConfiguration) WithPrefixes(values ...commonv1beta1.IPPrefix) *NetworkInterfaceStatusApplyConfiguration {
	for i := range values {
...
func (b *NetworkInterfaceStatusApplyConfiguration) WithVirtualIP(value commonv1beta1.IP) *NetworkInterfaceStatusApplyConfiguration {
	b.VirtualIP = &value
	return b
}
