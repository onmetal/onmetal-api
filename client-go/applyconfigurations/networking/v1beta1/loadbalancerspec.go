...
type LoadBalancerSpecApplyConfiguration struct {
	Type                     *v1beta1.LoadBalancerType               `json:"type,omitempty"`
...
func (b *LoadBalancerSpecApplyConfiguration) WithType(value v1beta1.LoadBalancerType) *LoadBalancerSpecApplyConfiguration {
	b.Type = &value
	return b
}
