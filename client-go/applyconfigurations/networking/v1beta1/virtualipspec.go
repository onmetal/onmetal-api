...
type VirtualIPSpecApplyConfiguration struct {
	Type      *v1beta1.VirtualIPType                             `json:"type,omitempty"`
	IPFamily  *v1.IPFamily                                       `json:"ipFamily,omitempty"`
	TargetRef *commonv1beta1.LocalUIDReferenceApplyConfiguration `json:"targetRef,omitempty"`
}
...
func (b *VirtualIPSpecApplyConfiguration) WithType(value v1beta1.VirtualIPType) *VirtualIPSpecApplyConfiguration {
	b.Type = &value
	return b
}
...
func (b *VirtualIPSpecApplyConfiguration) WithTargetRef(value *commonv1beta1.LocalUIDReferenceApplyConfiguration) *VirtualIPSpecApplyConfiguration {
	b.TargetRef = value
	return b
}
