...
import (
	v1beta1 "github.com/onmetal/onmetal-api/client-go/applyconfigurations/core/v1beta1"
)
...
type NetworkPolicyPeerApplyConfiguration struct {
	ObjectSelector *v1beta1.ObjectSelectorApplyConfiguration `json:"objectSelector,omitempty"`
...
func (b *NetworkPolicyPeerApplyConfiguration) WithObjectSelector(value *v1beta1.ObjectSelectorApplyConfiguration) *NetworkPolicyPeerApplyConfiguration {
