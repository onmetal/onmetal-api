...
// Experimental!
func ExtractLoadBalancer(loadBalancer *networkingv1beta1.LoadBalancer, fieldManager string) (*LoadBalancerApplyConfiguration, error) {
...
// Experimental!
func ExtractLoadBalancerStatus(loadBalancer *networkingv1beta1.LoadBalancer, fieldManager string) (*LoadBalancerApplyConfiguration, error) {
	return extractLoadBalancer(loadBalancer, fieldManager, "status")
}

func extractLoadBalancer(loadBalancer *networkingv1beta1.LoadBalancer, fieldManager string, subresource string) (*LoadBalancerApplyConfiguration, error) {
	b := &LoadBalancerApplyConfiguration{}
	err := managedfields.ExtractInto(loadBalancer, internal.Parser().Type("com.github.onmetal.onmetal-api.api.networking.v1beta1.LoadBalancer"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
