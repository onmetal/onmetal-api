...
type NATGatewaySpecApplyConfiguration struct {
	Type                     *v1beta1.NATGatewayType  `json:"type,omitempty"`
...
func (b *NATGatewaySpecApplyConfiguration) WithType(value v1beta1.NATGatewayType) *NATGatewaySpecApplyConfiguration {
	b.Type = &value
	return b
}
