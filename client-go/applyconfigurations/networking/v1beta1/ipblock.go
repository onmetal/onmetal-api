...
type IPBlockApplyConfiguration struct {
	CIDR   *v1beta1.IPPrefix  `json:"cidr,omitempty"`
	Except []v1beta1.IPPrefix `json:"except,omitempty"`
}
...
func (b *IPBlockApplyConfiguration) WithCIDR(value v1beta1.IPPrefix) *IPBlockApplyConfiguration {
	b.CIDR = &value
	return b
}
...
func (b *IPBlockApplyConfiguration) WithExcept(values ...v1beta1.IPPrefix) *IPBlockApplyConfiguration {
	for i := range values {
