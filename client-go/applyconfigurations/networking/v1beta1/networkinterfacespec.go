...
type NetworkInterfaceSpecApplyConfiguration struct {
	...
	MachineRef *v1beta1.LocalUIDReferenceApplyConfiguration `json:"machineRef,omitempty"`
...
func (b *NetworkInterfaceSpecApplyConfiguration) WithMachineRef(value *v1beta1.LocalUIDReferenceApplyConfiguration) *NetworkInterfaceSpecApplyConfiguration {
	b.MachineRef = value
	return b
}
