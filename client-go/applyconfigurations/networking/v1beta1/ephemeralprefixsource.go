...
import (
	v1beta1 "github.com/onmetal/onmetal-api/client-go/applyconfigurations/ipam/v1beta1"
)
...
type EphemeralPrefixSourceApplyConfiguration struct {
	PrefixTemplate *v1beta1.PrefixTemplateSpecApplyConfiguration `json:"prefixTemplate,omitempty"`
}
...
func (b *EphemeralPrefixSourceApplyConfiguration) WithPrefixTemplate(value *v1beta1.PrefixTemplateSpecApplyConfiguration) *EphemeralPrefixSourceApplyConfiguration {
