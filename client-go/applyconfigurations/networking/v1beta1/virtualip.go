...
// Experimental!
func ExtractVirtualIP(virtualIP *networkingv1beta1.VirtualIP, fieldManager string) (*VirtualIPApplyConfiguration, error) {
...
// Experimental!
func ExtractVirtualIPStatus(virtualIP *networkingv1beta1.VirtualIP, fieldManager string) (*VirtualIPApplyConfiguration, error) {
	return extractVirtualIP(virtualIP, fieldManager, "status")
}

func extractVirtualIP(virtualIP *networkingv1beta1.VirtualIP, fieldManager string, subresource string) (*VirtualIPApplyConfiguration, error) {
	b := &VirtualIPApplyConfiguration{}
	err := managedfields.ExtractInto(virtualIP, internal.Parser().Type("com.github.onmetal.onmetal-api.api.networking.v1beta1.VirtualIP"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
