...
// Experimental!
func ExtractNATGateway(nATGateway *networkingv1beta1.NATGateway, fieldManager string) (*NATGatewayApplyConfiguration, error) {
...
// Experimental!
func ExtractNATGatewayStatus(nATGateway *networkingv1beta1.NATGateway, fieldManager string) (*NATGatewayApplyConfiguration, error) {
	return extractNATGateway(nATGateway, fieldManager, "status")
}

func extractNATGateway(nATGateway *networkingv1beta1.NATGateway, fieldManager string, subresource string) (*NATGatewayApplyConfiguration, error) {
	b := &NATGatewayApplyConfiguration{}
	err := managedfields.ExtractInto(nATGateway, internal.Parser().Type("com.github.onmetal.onmetal-api.api.networking.v1beta1.NATGateway"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
