...
type NetworkPolicyConditionApplyConfiguration struct {
	Type               *v1beta1.NetworkPolicyConditionType `json:"type,omitempty"`
...
func (b *NetworkPolicyConditionApplyConfiguration) WithType(value v1beta1.NetworkPolicyConditionType) *NetworkPolicyConditionApplyConfiguration {
	b.Type = &value
	return b
}
