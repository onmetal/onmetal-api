...
type NetworkStatusApplyConfiguration struct {
	State    *v1beta1.NetworkState                    `json:"state,omitempty"`
...
func (b *NetworkStatusApplyConfiguration) WithState(value v1beta1.NetworkState) *NetworkStatusApplyConfiguration {
	b.State = &value
	return b
}
