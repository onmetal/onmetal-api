...
// Experimental!
func ExtractNetworkInterface(networkInterface *networkingv1beta1.NetworkInterface, fieldManager string) (*NetworkInterfaceApplyConfiguration, error) {
...
// Experimental!
func ExtractNetworkInterfaceStatus(networkInterface *networkingv1beta1.NetworkInterface, fieldManager string) (*NetworkInterfaceApplyConfiguration, error) {
	return extractNetworkInterface(networkInterface, fieldManager, "status")
}

func extractNetworkInterface(networkInterface *networkingv1beta1.NetworkInterface, fieldManager string, subresource string) (*NetworkInterfaceApplyConfiguration, error) {
	b := &NetworkInterfaceApplyConfiguration{}
	err := managedfields.ExtractInto(networkInterface, internal.Parser().Type("com.github.onmetal.onmetal-api.api.networking.v1beta1.NetworkInterface"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(networkInterface.Name)
...
func (b *NetworkInterfaceApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
