...
// Experimental!
func ExtractNetworkPolicy(networkPolicy *networkingv1beta1.NetworkPolicy, fieldManager string) (*NetworkPolicyApplyConfiguration, error) {
...
// Experimental!
func ExtractNetworkPolicyStatus(networkPolicy *networkingv1beta1.NetworkPolicy, fieldManager string) (*NetworkPolicyApplyConfiguration, error) {
	return extractNetworkPolicy(networkPolicy, fieldManager, "status")
}

func extractNetworkPolicy(networkPolicy *networkingv1beta1.NetworkPolicy, fieldManager string, subresource string) (*NetworkPolicyApplyConfiguration, error) {
	b := &NetworkPolicyApplyConfiguration{}
	err := managedfields.ExtractInto(networkPolicy, internal.Parser().Type("com.github.onmetal.onmetal-api.api.networking.v1beta1.NetworkPolicy"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
