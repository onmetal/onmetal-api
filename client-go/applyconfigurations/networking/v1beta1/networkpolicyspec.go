...
type NetworkPolicySpecApplyConfiguration struct {
	...
	PolicyTypes              []networkingv1beta1.PolicyType               `json:"policyTypes,omitempty"`
}
...
func (b *NetworkPolicySpecApplyConfiguration) WithPolicyTypes(values ...networkingv1beta1.PolicyType) *NetworkPolicySpecApplyConfiguration {
	for i := range values {
