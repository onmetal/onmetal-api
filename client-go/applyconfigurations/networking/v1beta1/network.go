...
// Experimental!
func ExtractNetwork(network *networkingv1beta1.Network, fieldManager string) (*NetworkApplyConfiguration, error) {
...
// Experimental!
func ExtractNetworkStatus(network *networkingv1beta1.Network, fieldManager string) (*NetworkApplyConfiguration, error) {
	return extractNetwork(network, fieldManager, "status")
}

func extractNetwork(network *networkingv1beta1.Network, fieldManager string, subresource string) (*NetworkApplyConfiguration, error) {
	b := &NetworkApplyConfiguration{}
	err := managedfields.ExtractInto(network, internal.Parser().Type("com.github.onmetal.onmetal-api.api.networking.v1beta1.Network"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
