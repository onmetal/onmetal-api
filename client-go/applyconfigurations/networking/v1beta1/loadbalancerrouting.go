...
import (
	apinetworkingv1beta1 "github.com/onmetal/onmetal-api/api/networking/v1beta1"
	v1beta1 "github.com/onmetal/onmetal-api/client-go/applyconfigurations/common/v1beta1"
...
type LoadBalancerRoutingApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	NetworkRef                       *v1beta1.LocalUIDReferenceApplyConfiguration `json:"networkRef,omitempty"`
...
func LoadBalancerRouting(name, namespace string) *LoadBalancerRoutingApplyConfiguration {
	...
	b.WithAPIVersion("networking.api.onmetal.de/v1beta1")
	return b
}
...
// Experimental!
func ExtractLoadBalancerRouting(loadBalancerRouting *apinetworkingv1beta1.LoadBalancerRouting, fieldManager string) (*LoadBalancerRoutingApplyConfiguration, error) {
...
// Experimental!
func ExtractLoadBalancerRoutingStatus(loadBalancerRouting *apinetworkingv1beta1.LoadBalancerRouting, fieldManager string) (*LoadBalancerRoutingApplyConfiguration, error) {
	return extractLoadBalancerRouting(loadBalancerRouting, fieldManager, "status")
}

func extractLoadBalancerRouting(loadBalancerRouting *apinetworkingv1beta1.LoadBalancerRouting, fieldManager string, subresource string) (*LoadBalancerRoutingApplyConfiguration, error) {
	b := &LoadBalancerRoutingApplyConfiguration{}
	err := managedfields.ExtractInto(loadBalancerRouting, internal.Parser().Type("com.github.onmetal.onmetal-api.api.networking.v1beta1.LoadBalancerRouting"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
func (b *LoadBalancerRoutingApplyConfiguration) WithNetworkRef(value *v1beta1.LocalUIDReferenceApplyConfiguration) *LoadBalancerRoutingApplyConfiguration {
	b.NetworkRef = value
	return b
}
