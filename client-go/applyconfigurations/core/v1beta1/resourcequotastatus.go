...
type ResourceQuotaStatusApplyConfiguration struct {
	Hard *v1beta1.ResourceList `json:"hard,omitempty"`
	Used *v1beta1.ResourceList `json:"used,omitempty"`
}
...
func (b *ResourceQuotaStatusApplyConfiguration) WithHard(value v1beta1.ResourceList) *ResourceQuotaStatusApplyConfiguration {
	b.Hard = &value
	return b
}
...
func (b *ResourceQuotaStatusApplyConfiguration) WithUsed(value v1beta1.ResourceList) *ResourceQuotaStatusApplyConfiguration {
	b.Used = &value
	return b
}
