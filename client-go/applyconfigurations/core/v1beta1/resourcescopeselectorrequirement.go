...
type ResourceScopeSelectorRequirementApplyConfiguration struct {
	ScopeName *v1beta1.ResourceScope                 `json:"scopeName,omitempty"`
	Operator  *v1beta1.ResourceScopeSelectorOperator `json:"operator,omitempty"`
...
func (b *ResourceScopeSelectorRequirementApplyConfiguration) WithScopeName(value v1beta1.ResourceScope) *ResourceScopeSelectorRequirementApplyConfiguration {
	b.ScopeName = &value
	return b
}
...
func (b *ResourceScopeSelectorRequirementApplyConfiguration) WithOperator(value v1beta1.ResourceScopeSelectorOperator) *ResourceScopeSelectorRequirementApplyConfiguration {
	b.Operator = &value
	return b
}
