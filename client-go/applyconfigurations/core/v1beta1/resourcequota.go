...
func ResourceQuota(name, namespace string) *ResourceQuotaApplyConfiguration {
	...
	b.WithAPIVersion("core.api.onmetal.de/v1beta1")
	return b
}
...
// Experimental!
func ExtractResourceQuota(resourceQuota *corev1beta1.ResourceQuota, fieldManager string) (*ResourceQuotaApplyConfiguration, error) {
...
// Experimental!
func ExtractResourceQuotaStatus(resourceQuota *corev1beta1.ResourceQuota, fieldManager string) (*ResourceQuotaApplyConfiguration, error) {
	return extractResourceQuota(resourceQuota, fieldManager, "status")
}

func extractResourceQuota(resourceQuota *corev1beta1.ResourceQuota, fieldManager string, subresource string) (*ResourceQuotaApplyConfiguration, error) {
	b := &ResourceQuotaApplyConfiguration{}
	err := managedfields.ExtractInto(resourceQuota, internal.Parser().Type("com.github.onmetal.onmetal-api.api.core.v1beta1.ResourceQuota"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
