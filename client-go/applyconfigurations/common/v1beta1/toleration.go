...
type TolerationApplyConfiguration struct {
	...
	Operator *v1beta1.TolerationOperator `json:"operator,omitempty"`
	Value    *string                     `json:"value,omitempty"`
	Effect   *v1beta1.TaintEffect        `json:"effect,omitempty"`
}
...
func (b *TolerationApplyConfiguration) WithOperator(value v1beta1.TolerationOperator) *TolerationApplyConfiguration {
	b.Operator = &value
	return b
}
...
func (b *TolerationApplyConfiguration) WithEffect(value v1beta1.TaintEffect) *TolerationApplyConfiguration {
	b.Effect = &value
	return b
}
