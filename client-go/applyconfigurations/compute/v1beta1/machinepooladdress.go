...
type MachinePoolAddressApplyConfiguration struct {
	Type    *v1beta1.MachinePoolAddressType `json:"type,omitempty"`
...
func (b *MachinePoolAddressApplyConfiguration) WithType(value v1beta1.MachinePoolAddressType) *MachinePoolAddressApplyConfiguration {
	b.Type = &value
	return b
}
