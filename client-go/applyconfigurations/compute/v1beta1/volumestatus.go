...
type VolumeStatusApplyConfiguration struct {
	...
	State                   *v1beta1.VolumeState `json:"state,omitempty"`
...
func (b *VolumeStatusApplyConfiguration) WithState(value v1beta1.VolumeState) *VolumeStatusApplyConfiguration {
	b.State = &value
	return b
}
