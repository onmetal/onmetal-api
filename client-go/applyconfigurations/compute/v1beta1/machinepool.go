...
// MachinePoolApplyConfiguration represents an declarative configuration of the MachinePool type for use
// with apply.
...
// MachinePool constructs an declarative configuration of the MachinePool type for use with
// apply.
...
// Experimental!
func ExtractMachinePool(machinePool *computev1beta1.MachinePool, fieldManager string) (*MachinePoolApplyConfiguration, error) {
...
// Experimental!
func ExtractMachinePoolStatus(machinePool *computev1beta1.MachinePool, fieldManager string) (*MachinePoolApplyConfiguration, error) {
	return extractMachinePool(machinePool, fieldManager, "status")
}

func extractMachinePool(machinePool *computev1beta1.MachinePool, fieldManager string, subresource string) (*MachinePoolApplyConfiguration, error) {
	b := &MachinePoolApplyConfiguration{}
	err := managedfields.ExtractInto(machinePool, internal.Parser().Type("com.github.onmetal.onmetal-api.api.compute.v1beta1.MachinePool"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
