...
type MachineStatusApplyConfiguration struct {
	...
	State              *v1beta1.MachineState                      `json:"state,omitempty"`
...
func (b *MachineStatusApplyConfiguration) WithState(value v1beta1.MachineState) *MachineStatusApplyConfiguration {
	b.State = &value
	return b
}
