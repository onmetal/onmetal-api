...
type MachinePoolConditionApplyConfiguration struct {
	Type               *v1beta1.MachinePoolConditionType `json:"type,omitempty"`
...
func (b *MachinePoolConditionApplyConfiguration) WithType(value v1beta1.MachinePoolConditionType) *MachinePoolConditionApplyConfiguration {
	b.Type = &value
	return b
}
