...
import (
	v1beta1 "github.com/onmetal/onmetal-api/client-go/applyconfigurations/networking/v1beta1"
)
...
type EphemeralNetworkInterfaceSourceApplyConfiguration struct {
	NetworkInterfaceTemplate *v1beta1.NetworkInterfaceTemplateSpecApplyConfiguration `json:"networkInterfaceTemplate,omitempty"`
}
...
func (b *EphemeralNetworkInterfaceSourceApplyConfiguration) WithNetworkInterfaceTemplate(value *v1beta1.NetworkInterfaceTemplateSpecApplyConfiguration) *EphemeralNetworkInterfaceSourceApplyConfiguration {
