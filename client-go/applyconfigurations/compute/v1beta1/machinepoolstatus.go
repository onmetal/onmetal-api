...
type MachinePoolStatusApplyConfiguration struct {
	State                   *v1beta1.MachinePoolState                     `json:"state,omitempty"`
...
func (b *MachinePoolStatusApplyConfiguration) WithState(value v1beta1.MachinePoolState) *MachinePoolStatusApplyConfiguration {
	b.State = &value
	return b
}
...
func (b *MachinePoolStatusApplyConfiguration) WithCapacity(value corev1beta1.ResourceList) *MachinePoolStatusApplyConfiguration {
	b.Capacity = &value
	return b
}
...
func (b *MachinePoolStatusApplyConfiguration) WithAllocatable(value corev1beta1.ResourceList) *MachinePoolStatusApplyConfiguration {
	b.Allocatable = &value
	return b
}
