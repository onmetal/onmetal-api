...
// Experimental!
func ExtractMachine(machine *computev1beta1.Machine, fieldManager string) (*MachineApplyConfiguration, error) {
...
// Experimental!
func ExtractMachineStatus(machine *computev1beta1.Machine, fieldManager string) (*MachineApplyConfiguration, error) {
	return extractMachine(machine, fieldManager, "status")
}

func extractMachine(machine *computev1beta1.Machine, fieldManager string, subresource string) (*MachineApplyConfiguration, error) {
	b := &MachineApplyConfiguration{}
	err := managedfields.ExtractInto(machine, internal.Parser().Type("com.github.onmetal.onmetal-api.api.compute.v1beta1.Machine"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
