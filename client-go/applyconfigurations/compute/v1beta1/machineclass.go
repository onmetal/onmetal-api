...
func MachineClass(name string) *MachineClassApplyConfiguration {
	...
	b.WithAPIVersion("compute.api.onmetal.de/v1beta1")
	return b
}
...
// Experimental!
func ExtractMachineClass(machineClass *computev1beta1.MachineClass, fieldManager string) (*MachineClassApplyConfiguration, error) {
...
// Experimental!
func ExtractMachineClassStatus(machineClass *computev1beta1.MachineClass, fieldManager string) (*MachineClassApplyConfiguration, error) {
	return extractMachineClass(machineClass, fieldManager, "status")
}

func extractMachineClass(machineClass *computev1beta1.MachineClass, fieldManager string, subresource string) (*MachineClassApplyConfiguration, error) {
	b := &MachineClassApplyConfiguration{}
	err := managedfields.ExtractInto(machineClass, internal.Parser().Type("com.github.onmetal.onmetal-api.api.compute.v1beta1.MachineClass"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
func (b *MachineClassApplyConfiguration) WithCapabilities(value v1beta1.ResourceList) *MachineClassApplyConfiguration {
