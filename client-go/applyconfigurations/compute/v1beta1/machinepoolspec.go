...
type MachinePoolSpecApplyConfiguration struct {
	...
	Taints     []v1beta1.TaintApplyConfiguration `json:"taints,omitempty"`
}
...
func (b *MachinePoolSpecApplyConfiguration) WithTaints(values ...*v1beta1.TaintApplyConfiguration) *MachinePoolSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
