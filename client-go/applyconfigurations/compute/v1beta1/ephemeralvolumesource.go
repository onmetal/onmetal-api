...
import (
	v1beta1 "github.com/onmetal/onmetal-api/client-go/applyconfigurations/storage/v1beta1"
)
...
type EphemeralVolumeSourceApplyConfiguration struct {
	VolumeTemplate *v1beta1.VolumeTemplateSpecApplyConfiguration `json:"volumeTemplate,omitempty"`
}
...
func (b *EphemeralVolumeSourceApplyConfiguration) WithVolumeTemplate(value *v1beta1.VolumeTemplateSpecApplyConfiguration) *EphemeralVolumeSourceApplyConfiguration {
