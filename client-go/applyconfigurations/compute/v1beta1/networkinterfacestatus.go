...
type NetworkInterfaceStatusApplyConfiguration struct {
	...
	IPs                     []v1beta1.IP                          `json:"ips,omitempty"`
	VirtualIP               *v1beta1.IP                           `json:"virtualIP,omitempty"`
	State                   *computev1beta1.NetworkInterfaceState `json:"state,omitempty"`
...
func (b *NetworkInterfaceStatusApplyConfiguration) WithIPs(values ...v1beta1.IP) *NetworkInterfaceStatusApplyConfiguration {
	for i := range values {
...
func (b *NetworkInterfaceStatusApplyConfiguration) WithVirtualIP(value v1beta1.IP) *NetworkInterfaceStatusApplyConfiguration {
	b.VirtualIP = &value
	return b
}
...
func (b *NetworkInterfaceStatusApplyConfiguration) WithState(value computev1beta1.NetworkInterfaceState) *NetworkInterfaceStatusApplyConfiguration {
	b.State = &value
	return b
}
