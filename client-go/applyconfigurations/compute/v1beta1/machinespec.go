...
type MachineSpecApplyConfiguration struct {
	...
	Power               *v1beta1.Power                                     `json:"power,omitempty"`
	...
	IgnitionRef         *commonv1beta1.SecretKeySelectorApplyConfiguration `json:"ignitionRef,omitempty"`
	EFIVars             []EFIVarApplyConfiguration                         `json:"efiVars,omitempty"`
	Tolerations         []commonv1beta1.TolerationApplyConfiguration       `json:"tolerations,omitempty"`
}
...
func (b *MachineSpecApplyConfiguration) WithPower(value v1beta1.Power) *MachineSpecApplyConfiguration {
	b.Power = &value
	return b
}
...
func (b *MachineSpecApplyConfiguration) WithIgnitionRef(value *commonv1beta1.SecretKeySelectorApplyConfiguration) *MachineSpecApplyConfiguration {
	b.IgnitionRef = value
	return b
}
...
func (b *MachineSpecApplyConfiguration) WithTolerations(values ...*commonv1beta1.TolerationApplyConfiguration) *MachineSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
