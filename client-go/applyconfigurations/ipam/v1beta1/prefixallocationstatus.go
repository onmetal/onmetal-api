...
type PrefixAllocationStatusApplyConfiguration struct {
	Prefix                  *v1beta1.IPPrefix                  `json:"prefix,omitempty"`
	Phase                   *ipamv1beta1.PrefixAllocationPhase `json:"phase,omitempty"`
...
func (b *PrefixAllocationStatusApplyConfiguration) WithPrefix(value v1beta1.IPPrefix) *PrefixAllocationStatusApplyConfiguration {
	b.Prefix = &value
	return b
}
...
func (b *PrefixAllocationStatusApplyConfiguration) WithPhase(value ipamv1beta1.PrefixAllocationPhase) *PrefixAllocationStatusApplyConfiguration {
	b.Phase = &value
	return b
}
