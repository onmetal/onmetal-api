...
func PrefixAllocation(name, namespace string) *PrefixAllocationApplyConfiguration {
	...
	b.WithAPIVersion("ipam.api.onmetal.de/v1beta1")
	return b
}

// ExtractPrefixAllocation extracts the applied configuration owned by fieldManager from
// prefixAllocation. If no managedFields are found in prefixAllocation for fieldManager, a
// PrefixAllocationApplyConfiguration is returned with only the Name, Namespace (if applicable),
// APIVersion and Kind populated. It is possible that no managed fields were found for because other
// field managers have taken ownership of all the fields previously owned by fieldManager, or because
// the fieldManager never owned fields any fields.
// prefixAllocation must be a unmodified PrefixAllocation API object that was retrieved from the Kubernetes API.
// ExtractPrefixAllocation provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
// Experimental!
func ExtractPrefixAllocation(prefixAllocation *ipamv1beta1.PrefixAllocation, fieldManager string) (*PrefixAllocationApplyConfiguration, error) {
	return extractPrefixAllocation(prefixAllocation, fieldManager, "")
}

// ExtractPrefixAllocationStatus is the same as ExtractPrefixAllocation except
// that it extracts the status subresource applied configuration.
// Experimental!
func ExtractPrefixAllocationStatus(prefixAllocation *ipamv1beta1.PrefixAllocation, fieldManager string) (*PrefixAllocationApplyConfiguration, error) {
	return extractPrefixAllocation(prefixAllocation, fieldManager, "status")
}

func extractPrefixAllocation(prefixAllocation *ipamv1beta1.PrefixAllocation, fieldManager string, subresource string) (*PrefixAllocationApplyConfiguration, error) {
	b := &PrefixAllocationApplyConfiguration{}
	err := managedfields.ExtractInto(prefixAllocation, internal.Parser().Type("com.github.onmetal.onmetal-api.api.ipam.v1beta1.PrefixAllocation"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(prefixAllocation.Name)
...
func (b *PrefixAllocationApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
