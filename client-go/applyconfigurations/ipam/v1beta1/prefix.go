...
// Experimental!
func ExtractPrefix(prefix *ipamv1beta1.Prefix, fieldManager string) (*PrefixApplyConfiguration, error) {
...
// Experimental!
func ExtractPrefixStatus(prefix *ipamv1beta1.Prefix, fieldManager string) (*PrefixApplyConfiguration, error) {
	return extractPrefix(prefix, fieldManager, "status")
}

func extractPrefix(prefix *ipamv1beta1.Prefix, fieldManager string, subresource string) (*PrefixApplyConfiguration, error) {
	b := &PrefixApplyConfiguration{}
	err := managedfields.ExtractInto(prefix, internal.Parser().Type("com.github.onmetal.onmetal-api.api.ipam.v1beta1.Prefix"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
