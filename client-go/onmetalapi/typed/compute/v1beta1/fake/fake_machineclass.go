...
var machineclassesResource = v1beta1.SchemeGroupVersion.WithResource("machineclasses")

var machineclassesKind = v1beta1.SchemeGroupVersion.WithKind("MachineClass")

// Get takes name of the machineClass, and returns the corresponding machineClass object, and an error if there is any.
func (c *FakeMachineClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.MachineClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(machineclassesResource, name), &v1beta1.MachineClass{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeMachineClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.MachineClassList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(machineclassesResource, machineclassesKind, opts), &v1beta1.MachineClassList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeMachineClasses) Create(ctx context.Context, machineClass *v1beta1.MachineClass, opts v1.CreateOptions) (result *v1beta1.MachineClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(machineclassesResource, machineClass), &v1beta1.MachineClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.MachineClass), err
...
func (c *FakeMachineClasses) Update(ctx context.Context, machineClass *v1beta1.MachineClass, opts v1.UpdateOptions) (result *v1beta1.MachineClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(machineclassesResource, machineClass), &v1beta1.MachineClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.MachineClass), err
...
func (c *FakeMachineClasses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(machineclassesResource, name, opts), &v1beta1.MachineClass{})
	return err
}
...
func (c *FakeMachineClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.MachineClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(machineclassesResource, name, pt, data, subresources...), &v1beta1.MachineClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.MachineClass), err
...
func (c *FakeMachineClasses) Apply(ctx context.Context, machineClass *computev1beta1.MachineClassApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.MachineClass, err error) {
	if machineClass == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(machineclassesResource, *name, types.ApplyPatchType, data), &v1beta1.MachineClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.MachineClass), err
