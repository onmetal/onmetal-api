...
// ComputeV1beta1Client is used to interact with features provided by the compute.api.onmetal.de group.
type ComputeV1beta1Client struct {
	restClient rest.Interface
}

func (c *ComputeV1beta1Client) Machines(namespace string) MachineInterface {
	return newMachines(c, namespace)
}

func (c *ComputeV1beta1Client) MachineClasses() MachineClassInterface {
	return newMachineClasses(c)
}

func (c *ComputeV1beta1Client) MachinePools() MachinePoolInterface {
