...
type VolumeClassInterface interface {
	Create(ctx context.Context, volumeClass *v1beta1.VolumeClass, opts v1.CreateOptions) (*v1beta1.VolumeClass, error)
	Update(ctx context.Context, volumeClass *v1beta1.VolumeClass, opts v1.UpdateOptions) (*v1beta1.VolumeClass, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.VolumeClass, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.VolumeClassList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VolumeClass, err error)
	Apply(ctx context.Context, volumeClass *storagev1beta1.VolumeClassApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.VolumeClass, err error)
...
func newVolumeClasses(c *StorageV1beta1Client) *volumeClasses {
...
func (c *volumeClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VolumeClass, err error) {
	result = &v1beta1.VolumeClass{}
	err = c.client.Get().
...
func (c *volumeClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VolumeClassList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.VolumeClassList{}
	err = c.client.Get().
		Resource("volumeclasses").
...
func (c *volumeClasses) Create(ctx context.Context, volumeClass *v1beta1.VolumeClass, opts v1.CreateOptions) (result *v1beta1.VolumeClass, err error) {
	result = &v1beta1.VolumeClass{}
	err = c.client.Post().
		Resource("volumeclasses").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *volumeClasses) Update(ctx context.Context, volumeClass *v1beta1.VolumeClass, opts v1.UpdateOptions) (result *v1beta1.VolumeClass, err error) {
	result = &v1beta1.VolumeClass{}
	err = c.client.Put().
		Resource("volumeclasses").
...
func (c *volumeClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VolumeClass, err error) {
	result = &v1beta1.VolumeClass{}
...
func (c *volumeClasses) Apply(ctx context.Context, volumeClass *storagev1beta1.VolumeClassApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.VolumeClass, err error) {
	if volumeClass == nil {
