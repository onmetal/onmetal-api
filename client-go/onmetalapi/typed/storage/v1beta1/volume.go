...
type VolumeInterface interface {
	...
	Apply(ctx context.Context, volume *storagev1beta1.VolumeApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.Volume, err error)
	ApplyStatus(ctx context.Context, volume *storagev1beta1.VolumeApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.Volume, err error)
	VolumeExpansion
}
...
func newVolumes(c *StorageV1beta1Client, namespace string) *volumes {
	return &volumes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *volumes) Apply(ctx context.Context, volume *storagev1beta1.VolumeApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.Volume, err error) {
	if volume == nil {
...
func (c *volumes) ApplyStatus(ctx context.Context, volume *storagev1beta1.VolumeApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.Volume, err error) {
	if volume == nil {
		return nil, fmt.Errorf("volume provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
