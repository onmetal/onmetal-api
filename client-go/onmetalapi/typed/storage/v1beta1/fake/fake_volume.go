...
var volumesResource = v1beta1.SchemeGroupVersion.WithResource("volumes")

var volumesKind = v1beta1.SchemeGroupVersion.WithKind("Volume")
...
func (c *FakeVolumes) Apply(ctx context.Context, volume *storagev1beta1.VolumeApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.Volume, err error) {
	if volume == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(volumesResource, c.ns, *name, types.ApplyPatchType, data), &v1beta1.Volume{})
...
func (c *FakeVolumes) ApplyStatus(ctx context.Context, volume *storagev1beta1.VolumeApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.Volume, err error) {
	if volume == nil {
		return nil, fmt.Errorf("volume provided to Apply must not be nil")
	}
	data, err := json.Marshal(volume)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(volumesResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1beta1.Volume{})
