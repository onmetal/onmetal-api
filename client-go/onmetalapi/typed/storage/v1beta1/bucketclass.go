...
type BucketClassInterface interface {
	Create(ctx context.Context, bucketClass *v1beta1.BucketClass, opts v1.CreateOptions) (*v1beta1.BucketClass, error)
	Update(ctx context.Context, bucketClass *v1beta1.BucketClass, opts v1.UpdateOptions) (*v1beta1.BucketClass, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.BucketClass, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.BucketClassList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.BucketClass, err error)
	Apply(ctx context.Context, bucketClass *storagev1beta1.BucketClassApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.BucketClass, err error)
...
func newBucketClasses(c *StorageV1beta1Client) *bucketClasses {
...
func (c *bucketClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.BucketClass, err error) {
	result = &v1beta1.BucketClass{}
	err = c.client.Get().
...
func (c *bucketClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.BucketClassList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.BucketClassList{}
	err = c.client.Get().
		Resource("bucketclasses").
...
func (c *bucketClasses) Create(ctx context.Context, bucketClass *v1beta1.BucketClass, opts v1.CreateOptions) (result *v1beta1.BucketClass, err error) {
	result = &v1beta1.BucketClass{}
	err = c.client.Post().
		Resource("bucketclasses").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *bucketClasses) Update(ctx context.Context, bucketClass *v1beta1.BucketClass, opts v1.UpdateOptions) (result *v1beta1.BucketClass, err error) {
	result = &v1beta1.BucketClass{}
	err = c.client.Put().
		Resource("bucketclasses").
...
func (c *bucketClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.BucketClass, err error) {
	result = &v1beta1.BucketClass{}
...
func (c *bucketClasses) Apply(ctx context.Context, bucketClass *storagev1beta1.BucketClassApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.BucketClass, err error) {
	if bucketClass == nil {
