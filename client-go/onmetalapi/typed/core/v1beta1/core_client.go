...
// CoreV1beta1Client is used to interact with features provided by the core.api.onmetal.de group.
type CoreV1beta1Client struct {
	restClient rest.Interface
}

func (c *CoreV1beta1Client) ResourceQuotas(namespace string) ResourceQuotaInterface {
