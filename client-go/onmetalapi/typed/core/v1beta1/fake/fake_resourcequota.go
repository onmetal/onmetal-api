...
func (c *FakeResourceQuotas) Apply(ctx context.Context, resourceQuota *corev1beta1.ResourceQuotaApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ResourceQuota, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(resourcequotasResource, c.ns, *name, types.ApplyPatchType, data), &v1beta1.ResourceQuota{})
...
func (c *FakeResourceQuotas) ApplyStatus(ctx context.Context, resourceQuota *corev1beta1.ResourceQuotaApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ResourceQuota, err error) {
	if resourceQuota == nil {
		return nil, fmt.Errorf("resourceQuota provided to Apply must not be nil")
	}
	data, err := json.Marshal(resourceQuota)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(resourcequotasResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1beta1.ResourceQuota{})
