...
import (
	...
	corev1beta1 "github.com/onmetal/onmetal-api/client-go/applyconfigurations/core/v1beta1"
...
type ResourceQuotaInterface interface {
	...
	Apply(ctx context.Context, resourceQuota *corev1beta1.ResourceQuotaApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ResourceQuota, err error)
	ApplyStatus(ctx context.Context, resourceQuota *corev1beta1.ResourceQuotaApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ResourceQuota, err error)
...
func newResourceQuotas(c *CoreV1beta1Client, namespace string) *resourceQuotas {
...
func (c *resourceQuotas) Apply(ctx context.Context, resourceQuota *corev1beta1.ResourceQuotaApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ResourceQuota, err error) {
...
func (c *resourceQuotas) ApplyStatus(ctx context.Context, resourceQuota *corev1beta1.ResourceQuotaApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ResourceQuota, err error) {
	if resourceQuota == nil {
		return nil, fmt.Errorf("resourceQuota provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
