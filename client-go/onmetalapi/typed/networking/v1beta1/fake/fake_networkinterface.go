...
var networkinterfacesResource = v1beta1.SchemeGroupVersion.WithResource("networkinterfaces")

var networkinterfacesKind = v1beta1.SchemeGroupVersion.WithKind("NetworkInterface")
...
func (c *FakeNetworkInterfaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.NetworkInterface, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(networkinterfacesResource, c.ns, name), &v1beta1.NetworkInterface{})
...
func (c *FakeNetworkInterfaces) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.NetworkInterfaceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(networkinterfacesResource, networkinterfacesKind, c.ns, opts), &v1beta1.NetworkInterfaceList{})
...
func (c *FakeNetworkInterfaces) Create(ctx context.Context, networkInterface *v1beta1.NetworkInterface, opts v1.CreateOptions) (result *v1beta1.NetworkInterface, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(networkinterfacesResource, c.ns, networkInterface), &v1beta1.NetworkInterface{})
...
func (c *FakeNetworkInterfaces) Update(ctx context.Context, networkInterface *v1beta1.NetworkInterface, opts v1.UpdateOptions) (result *v1beta1.NetworkInterface, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(networkinterfacesResource, c.ns, networkInterface), &v1beta1.NetworkInterface{})
...
func (c *FakeNetworkInterfaces) UpdateStatus(ctx context.Context, networkInterface *v1beta1.NetworkInterface, opts v1.UpdateOptions) (*v1beta1.NetworkInterface, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(networkinterfacesResource, "status", c.ns, networkInterface), &v1beta1.NetworkInterface{})
...
func (c *FakeNetworkInterfaces) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(networkinterfacesResource, c.ns, name, opts), &v1beta1.NetworkInterface{})
...
func (c *FakeNetworkInterfaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.NetworkInterface, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(networkinterfacesResource, c.ns, name, pt, data, subresources...), &v1beta1.NetworkInterface{})
...
func (c *FakeNetworkInterfaces) Apply(ctx context.Context, networkInterface *networkingv1beta1.NetworkInterfaceApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.NetworkInterface, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(networkinterfacesResource, c.ns, *name, types.ApplyPatchType, data), &v1beta1.NetworkInterface{})
...
func (c *FakeNetworkInterfaces) ApplyStatus(ctx context.Context, networkInterface *networkingv1beta1.NetworkInterfaceApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.NetworkInterface, err error) {
	if networkInterface == nil {
		return nil, fmt.Errorf("networkInterface provided to Apply must not be nil")
	}
	data, err := json.Marshal(networkInterface)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(networkinterfacesResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1beta1.NetworkInterface{})
