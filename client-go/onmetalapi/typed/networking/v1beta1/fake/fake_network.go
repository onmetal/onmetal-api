...
var networksResource = v1beta1.SchemeGroupVersion.WithResource("networks")

var networksKind = v1beta1.SchemeGroupVersion.WithKind("Network")

// Get takes name of the network, and returns the corresponding network object, and an error if there is any.
func (c *FakeNetworks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Network, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworks) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.NetworkList, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworks) Create(ctx context.Context, network *v1beta1.Network, opts v1.CreateOptions) (result *v1beta1.Network, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworks) Update(ctx context.Context, network *v1beta1.Network, opts v1.UpdateOptions) (result *v1beta1.Network, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworks) UpdateStatus(ctx context.Context, network *v1beta1.Network, opts v1.UpdateOptions) (*v1beta1.Network, error) {
	obj, err := c.Fake.
...
func (c *FakeNetworks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(networksResource, c.ns, name, opts), &v1beta1.Network{})
...
func (c *FakeNetworks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Network, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworks) Apply(ctx context.Context, network *networkingv1beta1.NetworkApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.Network, err error) {
	if network == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(networksResource, c.ns, *name, types.ApplyPatchType, data), &v1beta1.Network{})
...
func (c *FakeNetworks) ApplyStatus(ctx context.Context, network *networkingv1beta1.NetworkApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.Network, err error) {
	if network == nil {
		return nil, fmt.Errorf("network provided to Apply must not be nil")
	}
	data, err := json.Marshal(network)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(networksResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1beta1.Network{})
