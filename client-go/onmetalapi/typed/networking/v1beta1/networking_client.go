...
// NetworkingV1beta1Client is used to interact with features provided by the networking.api.onmetal.de group.
...
func (c *NetworkingV1beta1Client) LoadBalancerRoutings(namespace string) LoadBalancerRoutingInterface {
	return newLoadBalancerRoutings(c, namespace)
}

func (c *NetworkingV1beta1Client) NATGateways(namespace string) NATGatewayInterface {
	return newNATGateways(c, namespace)
}

func (c *NetworkingV1beta1Client) Networks(namespace string) NetworkInterface {
	return newNetworks(c, namespace)
}

func (c *NetworkingV1beta1Client) NetworkInterfaces(namespace string) NetworkInterfaceInterface {
...
func (c *NetworkingV1beta1Client) VirtualIPs(namespace string) VirtualIPInterface {
