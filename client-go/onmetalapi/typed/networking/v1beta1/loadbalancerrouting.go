...
type LoadBalancerRoutingInterface interface {
	Create(ctx context.Context, loadBalancerRouting *v1beta1.LoadBalancerRouting, opts v1.CreateOptions) (*v1beta1.LoadBalancerRouting, error)
	Update(ctx context.Context, loadBalancerRouting *v1beta1.LoadBalancerRouting, opts v1.UpdateOptions) (*v1beta1.LoadBalancerRouting, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.LoadBalancerRouting, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.LoadBalancerRoutingList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.LoadBalancerRouting, err error)
	Apply(ctx context.Context, loadBalancerRouting *networkingv1beta1.LoadBalancerRoutingApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.LoadBalancerRouting, err error)
...
func newLoadBalancerRoutings(c *NetworkingV1beta1Client, namespace string) *loadBalancerRoutings {
...
func (c *loadBalancerRoutings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.LoadBalancerRouting, err error) {
	result = &v1beta1.LoadBalancerRouting{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *loadBalancerRoutings) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.LoadBalancerRoutingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.LoadBalancerRoutingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("loadbalancerroutings").
...
func (c *loadBalancerRoutings) Create(ctx context.Context, loadBalancerRouting *v1beta1.LoadBalancerRouting, opts v1.CreateOptions) (result *v1beta1.LoadBalancerRouting, err error) {
	result = &v1beta1.LoadBalancerRouting{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("loadbalancerroutings").
...
func (c *loadBalancerRoutings) Update(ctx context.Context, loadBalancerRouting *v1beta1.LoadBalancerRouting, opts v1.UpdateOptions) (result *v1beta1.LoadBalancerRouting, err error) {
	result = &v1beta1.LoadBalancerRouting{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loadbalancerroutings").
...
func (c *loadBalancerRoutings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.LoadBalancerRouting, err error) {
	result = &v1beta1.LoadBalancerRouting{}
...
func (c *loadBalancerRoutings) Apply(ctx context.Context, loadBalancerRouting *networkingv1beta1.LoadBalancerRoutingApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.LoadBalancerRouting, err error) {
