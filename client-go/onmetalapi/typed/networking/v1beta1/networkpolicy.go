...
type NetworkPolicyInterface interface {
	...
	Apply(ctx context.Context, networkPolicy *networkingv1beta1.NetworkPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.NetworkPolicy, err error)
	ApplyStatus(ctx context.Context, networkPolicy *networkingv1beta1.NetworkPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.NetworkPolicy, err error)
...
func (c *networkPolicies) Apply(ctx context.Context, networkPolicy *networkingv1beta1.NetworkPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.NetworkPolicy, err error) {
...
func (c *networkPolicies) ApplyStatus(ctx context.Context, networkPolicy *networkingv1beta1.NetworkPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.NetworkPolicy, err error) {
	if networkPolicy == nil {
		return nil, fmt.Errorf("networkPolicy provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
