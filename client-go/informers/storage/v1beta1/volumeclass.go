...
type VolumeClassInformer interface {
	...
	Lister() v1beta1.VolumeClassLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.StorageV1beta1().VolumeClasses().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StorageV1beta1().VolumeClasses().Watch(context.TODO(), options)
			},
		},
...
func (f *volumeClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&storagev1beta1.VolumeClass{}, f.defaultInformer)
}

func (f *volumeClassInformer) Lister() v1beta1.VolumeClassLister {
	return v1beta1.NewVolumeClassLister(f.Informer().GetIndexer())
}
