...
type BucketClassInformer interface {
	...
	Lister() v1beta1.BucketClassLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.StorageV1beta1().BucketClasses().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StorageV1beta1().BucketClasses().Watch(context.TODO(), options)
			},
		},
...
func (f *bucketClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&storagev1beta1.BucketClass{}, f.defaultInformer)
}

func (f *bucketClassInformer) Lister() v1beta1.BucketClassLister {
	return v1beta1.NewBucketClassLister(f.Informer().GetIndexer())
}
