...
type VolumePoolInformer interface {
	...
	Lister() v1beta1.VolumePoolLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.StorageV1beta1().VolumePools().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StorageV1beta1().VolumePools().Watch(context.TODO(), options)
			},
		},
...
func (f *volumePoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&storagev1beta1.VolumePool{}, f.defaultInformer)
}

func (f *volumePoolInformer) Lister() v1beta1.VolumePoolLister {
	return v1beta1.NewVolumePoolLister(f.Informer().GetIndexer())
}
