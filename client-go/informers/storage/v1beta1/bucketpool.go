...
type BucketPoolInformer interface {
	...
	Lister() v1beta1.BucketPoolLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.StorageV1beta1().BucketPools().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StorageV1beta1().BucketPools().Watch(context.TODO(), options)
			},
		},
...
func (f *bucketPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&storagev1beta1.BucketPool{}, f.defaultInformer)
}

func (f *bucketPoolInformer) Lister() v1beta1.BucketPoolLister {
	return v1beta1.NewBucketPoolLister(f.Informer().GetIndexer())
}
