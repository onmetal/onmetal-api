...
type MachinePoolInformer interface {
	...
	Lister() v1beta1.MachinePoolLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ComputeV1beta1().MachinePools().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ComputeV1beta1().MachinePools().Watch(context.TODO(), options)
			},
		},
...
func (f *machinePoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&computev1beta1.MachinePool{}, f.defaultInformer)
}

func (f *machinePoolInformer) Lister() v1beta1.MachinePoolLister {
	return v1beta1.NewMachinePoolLister(f.Informer().GetIndexer())
}
