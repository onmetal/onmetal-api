...
import (
	...
	v1beta1 "github.com/onmetal/onmetal-api/client-go/listers/compute/v1beta1"
...
type MachineClassInformer interface {
	...
	Lister() v1beta1.MachineClassLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ComputeV1beta1().MachineClasses().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ComputeV1beta1().MachineClasses().Watch(context.TODO(), options)
			},
		},
...
func (f *machineClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&computev1beta1.MachineClass{}, f.defaultInformer)
}

func (f *machineClassInformer) Lister() v1beta1.MachineClassLister {
	return v1beta1.NewMachineClassLister(f.Informer().GetIndexer())
}
