...
import (
	...
	v1beta1 "github.com/onmetal/onmetal-api/client-go/listers/ipam/v1beta1"
...
type PrefixAllocationInformer interface {
	...
	Lister() v1beta1.PrefixAllocationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IpamV1beta1().PrefixAllocations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IpamV1beta1().PrefixAllocations(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *prefixAllocationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ipamv1beta1.PrefixAllocation{}, f.defaultInformer)
}

func (f *prefixAllocationInformer) Lister() v1beta1.PrefixAllocationLister {
	return v1beta1.NewPrefixAllocationLister(f.Informer().GetIndexer())
}
