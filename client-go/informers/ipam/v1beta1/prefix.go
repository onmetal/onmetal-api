	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IpamV1beta1().Prefixes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IpamV1beta1().Prefixes(namespace).Watch(context.TODO(), options)
			},
		},
		&ipamv1beta1.Prefix{},
		resyncPeriod,
...
func (f *prefixInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ipamv1beta1.Prefix{}, f.defaultInformer)
}

func (f *prefixInformer) Lister() v1beta1.PrefixLister {
	return v1beta1.NewPrefixLister(f.Informer().GetIndexer())
}
