...
import (
	...
	v1beta1 "github.com/onmetal/onmetal-api/client-go/listers/core/v1beta1"
...
type ResourceQuotaInformer interface {
	...
	Lister() v1beta1.ResourceQuotaLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1beta1().ResourceQuotas(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1beta1().ResourceQuotas(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *resourceQuotaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1beta1.ResourceQuota{}, f.defaultInformer)
}

func (f *resourceQuotaInformer) Lister() v1beta1.ResourceQuotaLister {
	return v1beta1.NewResourceQuotaLister(f.Informer().GetIndexer())
}
