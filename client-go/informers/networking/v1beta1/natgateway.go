...
type NATGatewayInformer interface {
	...
	Lister() v1beta1.NATGatewayLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1beta1().NATGateways(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1beta1().NATGateways(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *nATGatewayInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkingv1beta1.NATGateway{}, f.defaultInformer)
}

func (f *nATGatewayInformer) Lister() v1beta1.NATGatewayLister {
	return v1beta1.NewNATGatewayLister(f.Informer().GetIndexer())
}
