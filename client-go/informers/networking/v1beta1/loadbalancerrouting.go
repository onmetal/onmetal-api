...
import (
	...
	v1beta1 "github.com/onmetal/onmetal-api/client-go/listers/networking/v1beta1"
...
type LoadBalancerRoutingInformer interface {
	...
	Lister() v1beta1.LoadBalancerRoutingLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1beta1().LoadBalancerRoutings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1beta1().LoadBalancerRoutings(namespace).Watch(context.TODO(), options)
			},
		},
		&networkingv1beta1.LoadBalancerRouting{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *loadBalancerRoutingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkingv1beta1.LoadBalancerRouting{}, f.defaultInformer)
}

func (f *loadBalancerRoutingInformer) Lister() v1beta1.LoadBalancerRoutingLister {
	return v1beta1.NewLoadBalancerRoutingLister(f.Informer().GetIndexer())
}
