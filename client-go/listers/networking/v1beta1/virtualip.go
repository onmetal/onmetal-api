...
// List lists all VirtualIPs in the indexer.
func (s *virtualIPLister) List(selector labels.Selector) (ret []*v1beta1.VirtualIP, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.VirtualIP))
	})
	return ret, err
}
...
// List lists all VirtualIPs in the indexer for a given namespace.
func (s virtualIPNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.VirtualIP, err error) {
...
// Get retrieves the VirtualIP from the indexer for a given namespace and name.
func (s virtualIPNamespaceLister) Get(name string) (*v1beta1.VirtualIP, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("virtualip"), name)
	}
	return obj.(*v1beta1.VirtualIP), nil
}
