...
// List lists all NetworkInterfaces in the indexer for a given namespace.
func (s networkInterfaceNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.NetworkInterface, err error) {
...
// Get retrieves the NetworkInterface from the indexer for a given namespace and name.
func (s networkInterfaceNamespaceLister) Get(name string) (*v1beta1.NetworkInterface, error) {
