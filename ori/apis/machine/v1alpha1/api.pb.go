...
func (m *PeeringSpec) Reset()      { *m = PeeringSpec{} }
func (*PeeringSpec) ProtoMessage() {}
func (*PeeringSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_00212fb1f9d3bf1c, []int{4}
}
func (m *PeeringSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PeeringSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PeeringSpec.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PeeringSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PeeringSpec.Merge(m, src)
}
func (m *PeeringSpec) XXX_Size() int {
	return m.Size()
}
func (m *PeeringSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_PeeringSpec.DiscardUnknown(m)
}

var xxx_messageInfo_PeeringSpec proto.InternalMessageInfo

func (m *PeeringSpec) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *PeeringSpec) GetHandle() string {
	if m != nil {
		return m.Handle
	}
	return ""
...
func (m *PeeringSpec) GetPhase() string {
	if m != nil {
		return m.Phase
	}
	return ""
...
func (m *PeeringSpec) GetPrefixes() []string {
	if m != nil {
		return m.Prefixes
	}
	return nil
...
type NetworkSpec struct {
	...
	InternetGateway      bool           `protobuf:"varint,2,opt,name=internetGateway,proto3" json:"internetGateway,omitempty"`
	Peerings             []*PeeringSpec `protobuf:"bytes,3,rep,name=peerings,proto3" json:"peerings,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *NetworkSpec) GetInternetGateway() bool {
	if m != nil {
...
func (m *NetworkSpec) GetPeerings() []*PeeringSpec {
	if m != nil {
		return m.Peerings
	}
	return nil
...
type LoadBalancerTargetSpec struct {
	LoadBalancerType     LoadBalancerType    `protobuf:"varint,1,opt,name=load_balancer_type,json=loadBalancerType,proto3,enum=machine.v1alpha1.LoadBalancerType" json:"load_balancer_type,omitempty"`
...
func (m *LoadBalancerTargetSpec) GetLoadBalancerType() LoadBalancerType {
	...
	return LoadBalancerType_PUBLIC
}
...
type UpdateMachineAnnotationsRequest struct {
	MachineId            string                   `protobuf:"bytes,1,opt,name=machine_id,json=machineId,proto3" json:"machine_id,omitempty"`
	Metadata             *v1alpha1.ObjectMetadata `protobuf:"bytes,2,opt,name=metadata,proto3" json:"metadata,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
func (m *UpdateMachineAnnotationsRequest) GetMetadata() *v1alpha1.ObjectMetadata {
	if m != nil {
		return m.Metadata
	}
	return nil
...
func (m *UpdateNetworkRequest) GetHandle() string {
	if m != nil {
		return m.Handle
	}
	return ""
...
func (m *UpdateNetworkRequest) GetInternetGateway() bool {
	if m != nil {
		return m.InternetGateway
	}
	return false
...
func (m *UpdateNetworkRequest) GetPeerings() []*PeeringSpec {
	if m != nil {
		return m.Peerings
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("machine.v1alpha1.LoadBalancerType", LoadBalancerType_name, LoadBalancerType_value)
	...
	proto.RegisterType((*PeeringSpec)(nil), "machine.v1alpha1.PeeringSpec")
	...
	proto.RegisterType((*UpdateNetworkRequest)(nil), "machine.v1alpha1.UpdateNetworkRequest")
	proto.RegisterType((*UpdateNetworkResponse)(nil), "machine.v1alpha1.UpdateNetworkResponse")
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
...
func (c *machineRuntimeClient) UpdateNetwork(ctx context.Context, in *UpdateNetworkRequest, opts ...grpc.CallOption) (*UpdateNetworkResponse, error) {
	out := new(UpdateNetworkResponse)
	err := c.cc.Invoke(ctx, "/machine.v1alpha1.MachineRuntime/UpdateNetwork", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMachineRuntimeServer) UpdateNetwork(ctx context.Context, req *UpdateNetworkRequest) (*UpdateNetworkResponse, error) {
...
func _MachineRuntime_UpdateNetwork_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateNetworkRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MachineRuntimeServer).UpdateNetwork(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/machine.v1alpha1.MachineRuntime/UpdateNetwork",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MachineRuntimeServer).UpdateNetwork(ctx, req.(*UpdateNetworkRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MachineRuntime_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MachineRuntime_UpdateNetwork_Handler,
		},
		{
...
func (m *PeeringSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PeeringSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PeeringSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Phase) > 0 {
		i -= len(m.Phase)
		copy(dAtA[i:], m.Phase)
		i = encodeVarintApi(dAtA, i, uint64(len(m.Phase)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Handle) > 0 {
...
func (m *NetworkSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Peerings) > 0 {
		for iNdEx := len(m.Peerings) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Peerings[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *LoadBalancerTargetSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LoadBalancerType != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.LoadBalancerType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *LoadBalancerTargetSpec) Size() (n int) {
	...
	_ = l
	if m.LoadBalancerType != 0 {
		n += 1 + sovApi(uint64(m.LoadBalancerType))
	}
	l = len(m.Ip)
	if l > 0 {
		n += 1 + l + sovApi(uint64(l))
...
func (this *PeeringSpec) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&PeeringSpec{`,
...
func (this *NetworkSpec) String() string {
	...
	repeatedStringForPeerings := "[]*PeeringSpec{"
	for _, f := range this.Peerings {
		repeatedStringForPeerings += strings.Replace(f.String(), "PeeringSpec", "PeeringSpec", 1) + ","
	}
	repeatedStringForPeerings += "}"
	s := strings.Join([]string{`&NetworkSpec{`,
		`Handle:` + fmt.Sprintf("%v", this.Handle) + `,`,
		`InternetGateway:` + fmt.Sprintf("%v", this.InternetGateway) + `,`,
		`Peerings:` + repeatedStringForPeerings + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *UpdateNetworkResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateNetworkResponse{`,
		`}`,
	}, "")
	return s
}
...
func (m *PeeringSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PeeringSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PeeringSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *NetworkSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InternetGateway", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InternetGateway = bool(v != 0)
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Peerings", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Peerings = append(m.Peerings, &PeeringSpec{})
			if err := m.Peerings[len(m.Peerings)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LoadBalancerType |= LoadBalancerType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
