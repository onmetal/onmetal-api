...
func (e *countEvaluator) countResourceName() corev1beta1.ResourceName {
	return corev1beta1.ObjectCountQuotaResourceNameFor(e.gr)
}
...
func (e *countEvaluator) MatchesResourceName(name corev1beta1.ResourceName) bool {
	return name == e.countResourceName()
}

func (e *countEvaluator) MatchesResourceScopeSelectorRequirement(_ client.Object, _ corev1beta1.ResourceScopeSelectorRequirement) (bool, error) {
	return false, nil
}

func (e *countEvaluator) Usage(context.Context, client.Object) (corev1beta1.ResourceList, error) {
...
type CapabilitiesReader interface {
	Get(ctx context.Context, className string) (corev1beta1.ResourceList, bool)
}

type getterCapabilitiesReader[T onmetalutilruntime.DeepCopier[T], K any] struct {
	getter              resourceaccess.Getter[T, K]
	extractCapabilities func(T) corev1beta1.ResourceList
	makeKey             func(string) K
}

func (g *getterCapabilitiesReader[T, K]) Get(ctx context.Context, className string) (corev1beta1.ResourceList, bool) {
