...
import (
	...
	networkingv1beta1 "github.com/onmetal/onmetal-api/internal/apis/networking/v1beta1"
...
func RegisterDefaults(scheme *runtime.Scheme) error {
	scheme.AddTypeDefaultingFunc(&v1beta1.Machine{}, func(obj interface{}) { SetObjectDefaults_Machine(obj.(*v1beta1.Machine)) })
	scheme.AddTypeDefaultingFunc(&v1beta1.MachineList{}, func(obj interface{}) { SetObjectDefaults_MachineList(obj.(*v1beta1.MachineList)) })
	return nil
}

func SetObjectDefaults_Machine(in *v1beta1.Machine) {
	...
	for i := range in.Spec.NetworkInterfaces {
		...
		if a.NetworkInterfaceSource.Ephemeral != nil {
			if a.NetworkInterfaceSource.Ephemeral.NetworkInterfaceTemplate != nil {
				networkingv1beta1.SetDefaults_NetworkInterfaceSpec(&a.NetworkInterfaceSource.Ephemeral.NetworkInterfaceTemplate.Spec)
				for j := range a.NetworkInterfaceSource.Ephemeral.NetworkInterfaceTemplate.Spec.IPs {
					...
					if b.Ephemeral != nil {
						if b.Ephemeral.PrefixTemplate != nil {
							ipamv1beta1.SetDefaults_PrefixSpec(&b.Ephemeral.PrefixTemplate.Spec)
						}
					}
				}
...
func SetObjectDefaults_MachineList(in *v1beta1.MachineList) {
