...
var _ = Describe("Prefix", func() {
		...
		Entry("IPv4 ipFamily prefix mismatch",
			&ipam.Prefix{
				Spec: ipam.PrefixSpec{
					...
					Prefix:   commonv1beta1.MustParseNewIPPrefix("beef::/64"),
				},
			},
			ContainElement(InvalidField("spec.prefix")),
		),
	...
	DescribeTable("ValidatePrefixUpdate",
		...
		Entry("immutable prefix if set",
			&ipam.Prefix{
				Spec: ipam.PrefixSpec{
					Prefix: commonv1beta1.MustParseNewIPPrefix("11.0.0.0/8"),
				},
			},
			&ipam.Prefix{
				Spec: ipam.PrefixSpec{
	...
	DescribeTable("ValidatePrefixStatus",
		...
		Entry("allocated overlapping used",
			&ipam.PrefixStatus{
				Phase: ipam.PrefixPhaseAllocated,
				Used: []commonv1beta1.IPPrefix{
					commonv1beta1.MustParseIPPrefix("10.0.0.0/8"),
					commonv1beta1.MustParseIPPrefix("10.0.0.0/16"),
				},
			},
		...
		Entry("allocated different ip families used",
			&ipam.PrefixStatus{
				...
				Used: []commonv1beta1.IPPrefix{
					commonv1beta1.MustParseIPPrefix("10.0.0.0/8"),
					commonv1beta1.MustParseIPPrefix("beef::/64"),
				},
			},
			ContainElement(InvalidField("status.used")),
		),
		...
		Entry("allocated valid",
			&ipam.PrefixStatus{
				...
				Used: []commonv1beta1.IPPrefix{
					commonv1beta1.MustParseIPPrefix("10.0.0.0/8"),
					commonv1beta1.MustParseIPPrefix("11.0.0.0/8"),
				},
			},
			BeEmpty(),
		),
