...
import (
	...
	resourcequotastorage "github.com/onmetal/onmetal-api/internal/registry/core/resourcequota/storage"
...
func (p StorageProvider) NewRESTStorage(apiResourceConfigSource serverstorage.APIResourceConfigSource, restOptionsGetter generic.RESTOptionsGetter) (genericapiserver.APIGroupInfo, bool, error) {
	...
	apiGroupInfo.VersionedResourcesStorageMap[corev1beta1.SchemeGroupVersion.Version] = storageMap
