...
func (in *EphemeralNetworkInterfaceSource) DeepCopyInto(out *EphemeralNetworkInterfaceSource) {
	*out = *in
	if in.NetworkInterfaceTemplate != nil {
		...
		*out = new(networkingv1beta1.NetworkInterfaceTemplateSpec)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
func (in *EphemeralVolumeSource) DeepCopyInto(out *EphemeralVolumeSource) {
	*out = *in
	if in.VolumeTemplate != nil {
		...
		*out = new(storagev1beta1.VolumeTemplateSpec)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
func (in *MachineClass) DeepCopyInto(out *MachineClass) {
	*out = *in
	...
	if in.Capabilities != nil {
		...
		*out = make(corev1beta1.ResourceList, len(*in))
...
func (in *MachinePoolSpec) DeepCopyInto(out *MachinePoolSpec) {
	*out = *in
	if in.Taints != nil {
		...
		*out = make([]commonv1beta1.Taint, len(*in))
		copy(*out, *in)
	}
	return
}
...
func (in *MachineSpec) DeepCopyInto(out *MachineSpec) {
	*out = *in
	...
	if in.IgnitionRef != nil {
		...
		*out = new(commonv1beta1.SecretKeySelector)
		**out = **in
	}
	if in.EFIVars != nil {
	...
	if in.Tolerations != nil {
		...
		*out = make([]commonv1beta1.Toleration, len(*in))
		copy(*out, *in)
	}
	return
}
...
func (in *NetworkInterfaceStatus) DeepCopyInto(out *NetworkInterfaceStatus) {
	*out = *in
	if in.IPs != nil {
		...
		*out = make([]commonv1beta1.IP, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
