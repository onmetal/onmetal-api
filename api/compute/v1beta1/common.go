...
type EphemeralNetworkInterfaceSource struct {
	...
	NetworkInterfaceTemplate *networkingv1beta1.NetworkInterfaceTemplateSpec `json:"networkInterfaceTemplate,omitempty"`
}
...
type EphemeralVolumeSource struct {
	...
	VolumeTemplate *storagev1beta1.VolumeTemplateSpec `json:"volumeTemplate,omitempty"`
}
