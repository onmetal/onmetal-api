...
type IPBlock struct {
	...
	CIDR commonv1beta1.IPPrefix `json:"cidr"`
	...
	Except []commonv1beta1.IPPrefix `json:"except,omitempty"`
}
...
type NetworkPolicyPeer struct {
	...
	ObjectSelector *corev1beta1.ObjectSelector `json:"objectSelector,omitempty"`
