...
type NetworkInterfaceSpec struct {
	...
	MachineRef *commonv1beta1.LocalUIDReference `json:"machineRef,omitempty"`
...
type IPSource struct {
	...
	Value *commonv1beta1.IP `json:"value,omitempty"`
...
type PrefixSource struct {
	...
	Value *commonv1beta1.IPPrefix `json:"value,omitempty"`
...
type NetworkInterfaceStatus struct {
	...
	IPs []commonv1beta1.IP `json:"ips,omitempty"`
	// Prefixes represent the prefixes routed to the NetworkInterface.
	Prefixes []commonv1beta1.IPPrefix `json:"prefixes,omitempty"`
	// VirtualIP is any virtual ip assigned to the NetworkInterface.
	VirtualIP *commonv1beta1.IP `json:"virtualIP,omitempty"`
}
