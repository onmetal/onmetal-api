...
type VolumePoolSpec struct {
	...
	Taints []commonv1beta1.Taint `json:"taints,omitempty"`
}
...
type VolumePoolStatus struct {
	...
	Capacity corev1beta1.ResourceList `json:"capacity,omitempty"`
	// Allocatable represents the resources of a machine pool that are available for scheduling.
	Allocatable corev1beta1.ResourceList `json:"allocatable,omitempty"`
}
