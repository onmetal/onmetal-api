...
// the VolumePoolRef object against the actual cluster state, and then
...
func (r *VolumePoolReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	storagePool := &storagev1alpha1.VolumePool{}
	...
	storagePool.Status.AvailableVolumeClasses = []corev1.LocalObjectReference{{Name: "slow"}, {Name: "fast"}}
